...
def FillNumDen(num):
    ...
    process.TnP_Trigger.Variables.mass = cms.vstring("Tag-muon Mass", _mrange, "3.3", "GeV/c^{2}")
...
Template = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    PDFs = cms.PSet(
        voigtPlusExpo = cms.vstring(
            "Voigtian::signal(mass, mean[3.1, 3.0, 3.2], width[0.1], sigma[0.05,0.02,0.1])",
...
if sample == "2018":
    process.TnP_Trigger = Template.clone(                                                                                                 
        InputFileNames = cms.vstring(                            
            '/afs/cern.ch/work/w/wshi/public/2018DataControlHLT/CMSSW_10_2_0/src/MuonAnalysis/TagAndProbe/test/zmumu/tnpJPsi_Data_All_Skim_Control_6.root'
            ),     
