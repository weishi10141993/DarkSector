...
muonMatchHLTL3NoVtx = muonTriggerMatchHLT.clone(matchedCuts = cms.string('coll("hltIterL3MuonCandidatesNoVtx")'), maxDeltaR = 0.1, maxDPtRel = 10.0)  #maxDeltaR Changed accordingly to Zoltan tuning. It was: 0.5
...
muonMatchHLTL3TNoVtx = muonTriggerMatchHLT.clone(matchedCuts = cms.string('coll("hltGlbTrkMuonCandsNoVtx")'),  maxDeltaR = 0.1, maxDPtRel = 10.0)  #maxDeltaR Changed accordingly to Zoltan tuning. It was: 0.5
...
patTriggerMatchers1MuInputTags = [
    ...
    cms.InputTag('muonMatchHLTL3NoVtx'),
    cms.InputTag('muonMatchHLTL3T'),
    cms.InputTag('muonMatchHLTL3TNoVtx'),
...
def switchOffAmbiguityResolution(process):
    ...
    process.muonMatchHLTL2NoVtx.resolveAmbiguities = False
    process.muonMatchHLTL3.resolveAmbiguities = False
    process.muonMatchHLTL3NoVtx.resolveAmbiguities = False
