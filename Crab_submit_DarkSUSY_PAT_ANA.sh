...
send "crab status -d crab_projects/crab_DarkSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_$NUMEVENTSK\_RAW2DIGI_L1Reco_RECO_MINIAOD_V2_v1\r"
expect {
...
expect "$ "
send "crab status -d crab_projects/crab_DarkSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_$NUMEVENTSK\_RAW2DIGI_L1Reco_RECO_MINIAOD_V2_v1 > Output_RAW_RECO_DarkSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_$NUMEVENTSK\.txt\r"
expect {
"Enter GRID pass phrase for this identity:" {
send "$gridpass\r"
}
...
expect "$ "
send "sed -i '/Output dataset:/!d' Output_RAW_RECO_DarkSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_$NUMEVENTSK\.txt\r"
expect "$ "
send "sed -i 's/Output dataset://g' Output_RAW_RECO_DarkSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_$NUMEVENTSK\.txt\r"
expect "$ "
send "sed -i 's/\^\[ \\t\]\*//' Output_RAW_RECO_DarkSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_$NUMEVENTSK\.txt\r"

expect "$ "
send "date >> Crab_DarkSUSY_PAT_ANA.log\r"
expect "$ "
send "echo \'User, Mass of N2 (string), Mass of GammaD (string), Lifetime of mGammaD(string), Number of Events, Number of Events (k): \' >> Crab_DarkSUSY_PAT_ANA.log \r"
expect "$ "
send "echo \'wshi, $N2MASS, $MASS, $LIFETIMESTRING, $NUMEVENTS, $NUMEVENTSK  \' >> Crab_DarkSUSY_PAT_ANA.log \r"
expect "$ "
send "echo \'\\n\' >> Crab_DarkSUSY_PAT_ANA.log \r"
expect "$ "
}
