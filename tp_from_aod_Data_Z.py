...
process.tpTree = cms.EDAnalyzer("TagProbeFitTreeProducer",
    ...
    flags = cms.PSet(
       ...
       Control16ByFilter = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sSingleMu7L1f0L2f10OneMuL3Filtered16NoVtx').empty()"),  
       ...
       Control6ByFilter = cms.string("!triggerObjectMatchesByFilter('hltL3fL1sSingleMu3L1f0L2f10OneMuL3Filtered6NoVtx').empty()"),
