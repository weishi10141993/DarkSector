...
send "cp RAW_RECO_CRAB3_NMSSM_mH_100_mA_1000_13TeV.py RAW_RECO_CRAB3_DARKSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_events$NUMEVENTSK\.py\r"
expect "$ "
send "sed -i '3s/NMSSM_mH_100_mA_1000_13TeV_RAW2DIGI_L1Reco_RECO_MINIAOD_V2_v1/DarkSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_$NUMEVENTSK\_RAW2DIGI_L1Reco_RECO_MINIAOD_V2_v1/' RAW_RECO_CRAB3_DARKSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_events$NUMEVENTSK\.py\r"
expect "$ "
send "sed -i '15s/NMSSM_mH_100_mA_1000_13TeV_RAW2DIGI_L1Reco_RECO_MINIAOD_V2_v1/DarkSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_$NUMEVENTSK\_RAW2DIGI_L1Reco_RECO_MINIAOD_V2_v1/' RAW_RECO_CRAB3_DARKSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_events$NUMEVENTSK\.py\r"
expect "$ "
send "sed -i \"s|/NMSSM_mH_100_mA_1000_13TeV_MG452_BR224_LHE_pythia8_GEN_SIM_MINIAOD_V2_v1/wshi-NMSSM_mH_100_mA_1000_13TeV_DIGI_L1_DIGI2RAW_HLT_PU_MINIAOD_V2_v1-fdb5c2f88f0aa1d28ef604db17a5c78c/USER|\$(cat Output_DIGI_RAW_DarkSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_$NUMEVENTSK\.txt)|\" RAW_RECO_CRAB3_DARKSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_events$NUMEVENTSK\.py\r"
expect "$ "
send "crab submit -c RAW_RECO_CRAB3_DARKSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_events$NUMEVENTSK\.py --wait\r"
expect {
...
expect "$ "
send "date >> Crab_submit_DarkSUSY_RAW_RECO.log\r"
expect "$ "
send "echo \'User, Mass of N2 (string), Mass of GammaD (string), Lifetime of mGammaD(string), Number of Events, Number of Events (k): \' >> Crab_submit_DarkSUSY_RAW_RECO.log \r"
expect "$ "
send "echo \'wshi, $N2MASS, $MASS, $LIFETIMESTRING, $NUMEVENTS, $NUMEVENTSK  \' >> Crab_submit_DarkSUSY_RAW_RECO.log \r"
expect "$ "
send "echo \'\\n\' >> Crab_submit_DarkSUSY_RAW_RECO.log \r"
expect "$ "
}
