...
def FillNumDen(num, den):
    ...
    if den == "highptid" :
        ...
        process.TnP_MuonID.Variables.mass = cms.vstring("Tag-muon Mass", _mrange, "3.35", "GeV/c^{2}")
...
def FillBin(par):
    ...
    if par == 'newpt_eta':
        ...
        DEN.pt = cms.vdouble(8, 10, 15, 20, 25, 30, 35, 40, 45, 50, 60)
    elif par == 'pt_eta':
        DEN.pt = cms.vdouble(8, 10, 15, 20, 25, 30, 35, 40, 45, 50, 60)
        DEN.abseta = cms.vdouble( 0., 0.9, 1.2, 2.1, 2.4)
    elif par == 'vtx':
...
Template = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    PDFs = cms.PSet(
        ...
        vpvPlusExpo = cms.vstring(#default shape
            "Voigtian::signal1(mass, mean1[3.1,3.0,3.2], width[0.1], sigma1[0.05, 0.02, 0.1])".replace("mass",mass_),
            "Voigtian::signal2(mass, mean2[3.1,3.0,3.2], width[0.1], sigma2[0.1, 0.04, 0.3])".replace("mass",mass_),
...
if sample == "data_J_Psi":
    process.TnP_MuonID = Template.clone(
        InputFileNames = cms.vstring(
            #'TnPTree_80X_Run2016B_v2_GoldenJSON_Run271036to275125_incomplete_skim.root',
            'tnpJPsi_Data_Run2016B_part1_skim.root',
            ),
        ...
        if bgFitFunction == 'default':
            ...
            if ('pt' in X):
                ...
                if den == "highptid" or num == "highptid":
                    ...
                    print 'Low pT...'
                    if (len(DEN.pt)==11):
                        print 'len of DEN.pt is 11, assign fit function for all pT bins...'
