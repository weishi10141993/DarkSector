...
send "tmux\r"
expect "$ "
send "cd /afs/cern.ch/work/w/wshi/public/DisplacedMuonJetAnalysis/CMSSW_8_0_20/src\r"
expect "$ "
send "cmsenv\r"
expect "$ "
...
send "cp PAT_ANA_CRAB3_NMSSM_mH_100_mA_1000_13TeV.py PAT_ANA_CRAB3_DARKSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_events$NUMEVENTSK\.py\r"
expect "$ "
send "sed -i '3s/NMSSM_mH_100_mA_1000_13TeV_PAT_ANA_MINIAOD_V2_v1/DarkSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_$NUMEVENTSK\_PAT_ANA/' PAT_ANA_CRAB3_DARKSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_events$NUMEVENTSK\.py\r"
expect "$ "
send "sed -i '15s/NMSSM_mH_100_mA_1000_13TeV_PAT_ANA_MINIAOD_V2_v1/DarkSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_$NUMEVENTSK\_PAT_ANA/' PAT_ANA_CRAB3_DARKSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_events$NUMEVENTSK\.py\r"
expect "$ "
send "sed -i \"s|/NMSSM_mH_100_mA_1000_13TeV_MG452_BR224_LHE_pythia8_GEN_SIM_MINIAOD_V2_v1/wshi-NMSSM_mH_100_mA_1000_13TeV_MINIAOD_MINIAOD_V2_v1-e3a368049cd46ad2a31a86481bd125dd/USER|\$(cat Output_RAW_RECO_DarkSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_$NUMEVENTSK\.txt)|\" PAT_ANA_CRAB3_DARKSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_events$NUMEVENTSK\.py\r"
expect "$ "
send "crab submit -c PAT_ANA_CRAB3_DARKSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_events$NUMEVENTSK\.py --wait\r"
expect {
...
expect "$ "
send "date >> Crab_submit_DarkSUSY_PAT_ANA_SUBMIT.log\r"
expect "$ "
send "echo \'User, Mass of N2 (string), Mass of GammaD (string), Lifetime of mGammaD(string), Number of Events, Number of Events (k): \' >> Crab_submit_DarkSUSY_PAT_ANA_SUBMIT.log \r"
expect "$ "
send "echo \'wshi, $N2MASS, $MASS, $LIFETIMESTRING, $NUMEVENTS, $NUMEVENTSK  \' >> Crab_submit_DarkSUSY_PAT_ANA_SUBMIT.log \r"
expect "$ "
send "echo \'\\n\' >> Crab_submit_DarkSUSY_PAT_ANA_SUBMIT.log \r"
expect "$ "
}
