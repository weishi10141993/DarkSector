...
send "crab kill -d crab_projects/crab_DarkSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_$NUMEVENTSK\_PAT_ANA\r"
expect {
...
expect "$ "
send "date >> Crab_kill_DarkSUSY_PAT_ANA.log\r"
expect "$ "
send "echo \'User, Mass of N2 (string), Mass of GammaD (string), Lifetime of mGammaD(string), Number of Events, Number of Events (k): \' >> Crab_kill_DarkSUSY_PAT_ANA.log \r"
expect "$ "
send "echo \'wshi, $N2MASS, $MASS, $LIFETIMESTRING, $NUMEVENTS, $NUMEVENTSK  \' >> Crab_kill_DarkSUSY_PAT_ANA.log \r"
expect "$ "
send "echo \'\\n\' >> Crab_kill_DarkSUSY_PAT_ANA.log \r"
expect "$ "
}
