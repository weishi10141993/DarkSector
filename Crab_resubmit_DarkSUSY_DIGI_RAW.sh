...
send "crab resubmit -d crab_projects/crab_DarkSUSY_mH_125_mN1_$N2MASS\_mGammaD_$MASS\_cT_$LIFETIMESTRING\_13TeV_$NUMEVENTSK\_DIGI_L1_DIGI2RAW_HLT_PU_MINIAOD_V2_v1\r"
expect {
...
expect "$ "
send "date >> Crab_resubmit_DarkSUSY_DIGI_RAW.log\r"
expect "$ "
send "echo \'User, Mass of N2 (string), Mass of GammaD (string), Lifetime of mGammaD(string), Number of Events, Number of Events (k): \' >> Crab_resubmit_DarkSUSY_DIGI_RAW.log \r"
expect "$ "
send "echo \'wshi, $N2MASS, $MASS, $LIFETIMESTRING, $NUMEVENTS, $NUMEVENTSK  \' >> Crab_resubmit_DarkSUSY_DIGI_RAW.log \r"
expect "$ "
send "echo \'\\n\' >> Crab_resubmit_DarkSUSY_DIGI_RAW.log \r"
expect "$ "
}
