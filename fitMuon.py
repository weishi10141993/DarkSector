...
if sample == "data_J_Psi":
    process.TnP_MuonID = Template.clone(
        InputFileNames = cms.vstring(
            ...
            'tnpJPsi_Data_Run2016B_part2.root',
            'tnpJPsi_Data_Run2016C_part1.root',
            'tnpJPsi_Data_Run2016C_part2.root',
            'tnpJPsi_Data_Run2016D_part1_skim.root',
            'tnpJPsi_Data_Run2016D_part2.root',
            'tnpJPsi_Data_Run2016E_part1_skim.root',
            'tnpJPsi_Data_Run2016E_part2.root',
            'tnpJPsi_Data_Run2016F_part1.root',
            'tnpJPsi_Data_Run2016F_part2.root',
            'tnpJPsi_Data_Run2016G_part1_skim.root',
            'tnpJPsi_Data_Run2016G_part2.root',
            'tnpJPsi_Data_Run2016Hv2_skim.root',
            'tnpJPsi_Data_Run2016Hv3.root',
            ),
